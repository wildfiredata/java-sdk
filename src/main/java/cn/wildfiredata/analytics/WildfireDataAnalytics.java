 ...
 */
@Deprecated
public class WildfireDataAnalytics extends TDAnalytics {
    /**
     * Construct SDK
     *
     * @param consumer BatchConsumer, LoggerConsumer, DebugConsumer
     */
    public WildfireDataAnalytics(final ITDConsumer consumer) {
        this(consumer,false);
    }
     ...
     */
    public WildfireDataAnalytics(final ITDConsumer consumer, final boolean enableUUID) {
     ...
     */
    public WildfireDataAnalytics(final ITDConsumer consumer, final boolean enableUUID, final boolean isStrictModel) {
